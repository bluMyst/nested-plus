...
Instance::Name = ->
    ...
    @name = nameParts[0]
    if @name == '*PERSON*' or @name == '*MAN*' or @name == '*WOMAN*'
        ...
        #4chan made me do it
        @name = str
    else if @name == '*MEDIEVAL PERSON*' or @name == '*MEDIEVAL MAN*' or @name == '*MEDIEVAL WOMAN*'
        ...
        @name = str
    else if @name == '*ANCIENT PERSON*' or @name == '*ANCIENT MAN*' or @name == '*ANCIENT WOMAN*'
        ...
        if gender == 1 and randint(0, 250) == 1
            str = 'Dave'
        @name = str
    else if @name == '*FUTURE PERSON*' or @name == '*FUTURE MAN*' or @name == '*FUTURE WOMAN*'
