...
function CheckMissingThings() {
    ...
    for (var i in Things) {
        ...
        for (var i2 in thisThing.contains) {
            ...
            if (typeof(thisContent)!="string") { for (var i3 in thisContent) {allContents.push(thisContent[i3]);}
            }
    ...
    if (this.grown==false) {
        ...
        for (var i in this.type.contains) {
            ...
            if (toMake[1]==undefined) toMake[1]=1;
                ...
                makeProb=(toMake[1]+"?").split("%"); if (makeProb[1]!=undefined) {makeProb=makeProb[0];makeAmount=1;} else makeProb=100;
            }
...
function Toggle(what) {
    if (Instances[what].display==0) {
        ...
        for (var i in Instances[what].children) { if (Instances[what].children[i].grown==false) {Instances[what].children[i].Grow(0);Instances[what].children[i].List(0);}
        }
