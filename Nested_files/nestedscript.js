...
var CheckMissingThings, CleanThings, Debug, Instance, Instances, LaunchNest, Make, Thing, Things, ThingsN, Title, Toggle, WeightedChoose, choose, iN, randint;
...
Thing = function(name, contains, namegen) {
  this.name = name;
  this.contains = contains;
  this.namegen = namegen;
  if (this.namegen === void 0) {
    this.namegen = this.name;
  }
...
CheckMissingThings = function() {
  var allContents, allMissing, i, i2, i3, str, thisContent, thisThing;
  allContents = [];
  allMissing = [];
  for (i in Things) {
    thisThing = Things[i];
    for (i2 in thisThing.contains) {
    ...
    for (i in thisT.contains) {
      if (typeof thisT.contains[i] === 'string') {
        if (thisT.contains[i].charAt(0) === '.') {
          if (Things[thisT.contains[i].substring(1)] !== void 0) {
