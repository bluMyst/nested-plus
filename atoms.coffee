new Thing('hydrogen',       ['proton,1',    'neutron,0-3',  'electron,1'])
new Thing('helium',         ['proton,2',    'neutron,0-3',  'electron,2'])
new Thing('lithium',        ['proton,3',    'neutron,0-3',  'electron,3'])
new Thing('beryllium',      ['proton,4',    'neutron,0-3',  'electron,4'])
new Thing('boron',          ['proton,5',    'neutron,0-3',  'electron,5'])
new Thing('carbon',         ['proton,6',    'neutron,0-3',  'electron,6'])
new Thing('nitrogen',       ['proton,7',    'neutron,0-3',  'electron,7'])
new Thing('oxygen',         ['proton,8',    'neutron,0-3',  'electron,8'])
