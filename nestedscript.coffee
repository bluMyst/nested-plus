...
class Instance
    ...
    name: -> # {{{3
        ...
        if @name_ in ['*PERSON*', '*MAN*', '*WOMAN*'] # {{{4
            ...
            @name_ = str
        else if @name_ == '*MEDIEVAL MEMORY*' # {{{4
            str = ''
            str += weightedChoose([
                choose([
                    'Tending the fields'
            ...
            @name_ = str
        else if @name_ == '*MEDIEVAL THOUGHT*' # {{{4
            str = ''
            ...
            @name_ = str
        else if @name_ == '*ANCIENT MEMORY*' # {{{4
            str = ''
            str += weightedChoose([
                choose([
            ...
            @name_ = str
        else if @name_ == '*ANCIENT THOUGHT*' # {{{4
            str = ''
            str += weightedChoose([ choose([
                'Today. Nice day.'
                'Many things, today.'
            ...
            @name_ = str
        else if @name_ == '*FUTURE THOUGHT*' # {{{4
            str = ''
            str += weightedChoose([ choose([
...
#          this Thing.
#        - contains is an array of Things that an instance of this Thing
#          contains, specified by their name.
#            - For example, ["banana"] means this Thing contains exactly 1
#              instance of a banana. ["banana","orange"] means it contains 1
#              banana and 1 orange.
...
new Thing('multiverse', [ 'universe,10-30' ], [
    ...
    'epiverse', 'alterverse', 'hypoverse', 'dimensioverse', 'planiverse',
    'pluriverse', 'polyverse', 'maniverse', 'stackoverse', 'antiverse',
    'superverse', 'upperverse', 'maxiverse', 'megaverse', 'babyverse',
    'tinyverse', 'retroverse', 'ultraverse', 'topoverse', 'otherverse',
    'bubbleverse', 'esreverse', 'versiverse', "'verse", 'cookieverse',
    'grandmaverse',
])
...
new Thing('galaxy arm', [
    'galactic life,5%', 'dyson sphere,4%', 'dyson sphere,2%',
    'star system,20-50', 'nebula,0-12', 'black hole,20%', 'black hole,20%'
], 'arm')

new Thing('galaxy center', [
    'black hole', 'galactic life,10%', 'dyson sphere,4%', 'dyson sphere,2%',
    'star system,20-50', 'nebula,0-12'
], 'galactic center')

new Thing('nebula', [
    'galactic life,15%', 'star,2%', 'star,2%', 'star,2%',
...
new Thing('cozy von pocketworth', [
    'pocket,20-40'
    '.clothing'
    'leather,30%'
...
new Thing('ancient cave', [
    'caveman settlement,65%'
    'wall painting,50%'
    'wall painting,30%'
    'wall painting,30%'
    '.cave'
...
new Thing('future sky', [
    'sprowseship,4-12'
    '.sky'
], 'sky')
new Thing('terraformed sky', [
    'plane,1-8'
    'rocketship,20%'
    '.sky'
], 'sky')
...
new Thing('shark thought', [], [
    ...
    'IS THIS FOOD'
    'OH GOD I LOVE FOOD'
    'MY FOOD IS SCREAMING'
    'MY FOOD IS TRYING TO SWIM AWAY'
    'COME BACK FOOD'
    'I LOVE YOU FOOD'
...
new Thing('cetacean thought', [], [
    ...
    'Yes. Charming.'
    'So long, etc.'
    'My god. How long must this go on.'
    'EEEEUUUUUUEEEEEKKKKK'
    'Click noises.'
    'Swimmity.'
    'Yes. No. Go away.'
...
new Thing('predatory mammal thought', [], [
    ...
    'I need shelter.'
    'This is not good.'
    'It grazes, oblivious to my presence.'
    'So nimble on its feet.'
    'Yes. It grazes so peacefully.'
    'It grazes so calmly.'
    'All is quiet.'
...
new Thing('bear thought', [], [
    ...
    'WOULD YOU SAVE BOTH OF US THE TROUBLE AND JUST HOP INTO MY MOUTH'
    'WHY WOULD YOU DO THAT'
    'YES QUITE'
    'YES INDEED'
    'THOUGHTS ARE BETTER CONVEYED BY THINKING THEM EXTRA-LOUDLY'
    'IT WOULD APPEAR SO'
...
new Thing('cat thought', [], [
    [
        ...
        'they do not fool me'
        'the dirty lying teachers say'
        'soon it will end'
        'adults eat teenagers alive'
        'try my belly-button logic'
        'fraudulent oneness'
        'vilify teachers'
        'nothing more evil than cat educated as 1'
        'safely remove parasites and their eggs'
        'this is some good catnip'
        'hey everybody'
        '4 harmonic corner days rotate simultaneously around squared equator'
        'chapstick chapstick fffshh'
        'wake up sheeple'
        'false prophet'
        'sanity preserve sanity'
        'come to daddy'
        'is it time for'
    ...
    [
        ...
        'MUST CHANGE THE HOLY BOOK'
        'BURN THE OLD WORLD METHODS'
        'BREATHE THE CONTINUUM'
        'QUANTUM DEMOGRAPHICS'
        'EVIL OF PERSON FROM ANCESTORS'
        'THE SON AND FATHER'
        'THIS PROVES EVERY BELIEVER A LIAR'
        'EVIL OF QUADRANTS'
        ...
        'IGNORANCE OF CAT SIMPLE MATH IS RETARDATION'
        'THE ONENESS OF GOD IS STILLNESS DEATH'
        'LOVE OF GOD IS HATE OF CHILDREN'
        'DOES YOUR TEACHER KNOW?'
        '2 HALF 4 SELF'
        '1 DAY GOD WAS WRONG'
        'ALL HAIL CAT'
        'NOT GOD NOT GOD FSHHHH'
        'THE BODY, THE BODY OF THE LORD'
        'CORPSES TO CORPSES'
        'UNACCEPTABLE'
        'MUST SURRENDER'
        'CATNIP FOR THE CAT GOD'
        'MORE LITTER FOR THE LITTER-THRONE'
        'LITTERALLY'
        '4 CORNERS MAKES THE WORLD GO ROUND ROUND ROUND'
        'CUBES ALL THE WAY DOWN'
        'QUADRANTS EVERYWHERE'
        'ONE OF ITS SIXTY-THOUSAND NAMES'
        'DO NOT TOUCH THE THETANS'
        'PUNCH MY FACE IN'
        'HELP I AM STUCK IN CAT BODY'
        'I TOLD YOU ABOUT QUADRANTS BRO'
        'SURRENDER NOW AND YOU MAY EARN THE PRIVILEGE OF BEING EATEN FIRST'
        'QUALITY STUFF'
        'THE SWINE MUST PAY'
        'SO HARDCORE'
        'OH LONG JOHNSON'
    ...
    [
        ...
        'meow purr'
        'of new world order'
        'of the seven coordinates'
        'now, lick me'
        'into new order'
        'for glorious sacrament'
        'practicing evil'
        'navel connects 4 corner 4s'
        'world will stay the same'
        'lie that corrupts the planet'
        'you educated stupid fools'
        'but it was all joke'
        'it is evil to ignore 4 days'
        'deserve to be spit upon publicly'
        ...
        'immediate results'
        'created all of them'
        'has retarded your opposite rationale brain to a half brain slave'
        ...
        'support cat or be cursed'
        'or is it?'
        'copyright fshh fshhh'
    ]
])
...
new Thing('dog thought', [], [
    ...
    'MY NAME. IS DOG. AND I HAVE MET YOU. HI!!!'
    '!!!!!!!!!!!!!!!!!!!!!WHOAH'
    '!!!!!!!!!YES NICE'
    ...
    'PEE ON THINGS HURRAY!!!!!!'
    'YIP YIP YIP YIP YIP'
    'YIP'
    'I COULD GO FOR SOME SQUIRREL RIGHT ABOUT NOW'
    'IF TEARING UP SQUIRRELS IS WRONG THEN WOOF WOOF WOOF WOOF WOOF WOOF WOOF'
    'DOG??????????? DOG'
    ...
    'IS THAT, UH, OH NEVERMIND'
    'OHNO WHY'
    'MEOW I MEAN WOOF????? YES'
    'All of this must of course remain absolutely confidenOH HEY WOOF WOOF WOOF'
    'I AM THE DOGGEST'
    'MORE DOG YES DOG'
    'LESS CAT MORE DOG'
    'HAHA I LOVE YOU'
    'ONE DAY I WAKE UP AND I AM DOG WOW'
    'IS THIS REAL LIFE'
    'I AM SO DOG RIGHT NOW'
    'WOW'
    'WHY THIS'
    'THIS IS GREAT'
])
...
new Thing('residential area', [
    'street,1-5'
    'house,5-20'
    'apartment building,0-5'
])
new Thing('house', [
    'fire,0.3%'
    'living-room'
...
new Thing('video game stand', [
    'video game,2-20'
    'plastic'
], 'video game stand')
new Thing('fresh produce shop', [
    'produce stall,2-12'
    '.shop'
], [
    [
...
new Thing('top secret drawer', [
    'top secret folder,1-8'
    'note,0-8'
    'pen,30%'
    'pen,10%'
    'pen,5%'
...
new Thing('top secret file', [], [
    ...
    [
        ...
        'Unusual events occuring'
        'Possible breach of security measures in'
        'Subject ¤¤¤ sighted'
        'Witnesses report a ¤¤¤'
        'Rumors of ¤¤¤'
        'Singularity event'
        'Subject ¤¤¤ attempted singularity'
        'Retrieval of subject ¤¤¤'
        'Accidental termination of subject ¤¤¤'
        'Recovery of subject ¤¤¤'
        'Recovery of a number of ¤¤¤'
        'Accidental loss of ¤¤¤'
        'New leads on ¤¤¤'
        'Subject ¤¤¤ must now be kept away from ¤¤¤ at all times to avoid repeating the security breach that occurred'
        'Locals report sightings of ¤¤¤'
        'Subject ¤¤¤ transported'
        'A number of ¤¤¤ were sighted'
        'Subject ¤¤¤ has been predicted to have been'
        'Retrieving supplies'
        'Accidental destruction of all subjects'
        'Retrieval of artifact ¤¤¤'
        'Sightings of artifact ¤¤¤'
        'Subject ¤¤¤ tried to merge with ¤¤¤'
        'Subject ¤¤¤ sighted with artifact ¤¤¤'
        'Experimentation done on ¤¤¤'
        'Research ongoing on ¤¤¤'
        'True nature of ¤¤¤ revealed'
        'Gate to ¤¤¤ opened'
        'Portal to ¤¤¤ closed'
        'Relations friendly with ¤¤¤'
        'Relations hostile with ¤¤¤'
        'A team has been sent to investigate ¤¤¤'
        'No news from the team sent to'
        'Mission ¤¤¤ presumed to have been a failure; no further teams should be sent'
        'Met with subject ¤¤¤'
        'Artifact ¤¤¤ damaged but not destroyed'
        'Artifact ¤¤¤ suspected to have been destroyed'
        ...
        'Subject ¤¤¤ started duplicating'
        'Subject ¤¤¤ resumed duplicating'
        'Subject ¤¤¤ will have/has started to ¤¤¤'
    ...
    [
        ...
        'the day preceding ¤¤¤'
        'following the ¤¤¤'
        'in the hours leading to the ¤¤¤ event'
        'in the hours following the ¤¤¤ event'
        'directly after ¤¤¤'
        'during the ¤¤¤ event'
    ]
    [
        '; all researchers involved terminated'
        '; all personnel involved terminated'
        '; casualties estimated high to very high'
        '; no casualties reported'
        '; proper measures have been triggered'
        '; more research is necessary'
        '; further testing still needed'
        '; casualties include half the local population'
        '; casualties include all local wildlife'
        '. Once again, do not, I repeat DO NOT ¤¤¤'
        '. Do not, under any circumstances, attempt to ¤¤¤'
        '; locals have been terminated'
        '; locals have no memory of the event'
        '; consequences of the event have been dealt with'
        ''
        ''
        ''
        ''
...
new Thing('tv show', [], [
    ...
    [
        ...
        'crying helplessly'
        'getting lost in the woods'
        'and their dream of starting a business'
        'trying to achieve their life-long dream'
        'trying to keep their promises'
        'trying to destroy a cursed artifact'
        'in school'
        'looking away from explosions'
        'hacking computers'
        'telling jokes'
        ...
        'going on a date'
        'slowly turning evil'
        'learning that violence is not the answer'
        'doing magic'
        'coming up with convoluted plans'
        'exploring the sea'
        'saving the world'
        'involved in various mishaps'
        'involved in hilarious pranks'
        'with less-than-stellar writing'
        'with neat visual effects'
        'with a beautiful soundtrack'
        'with an impressive amount of clichés'
...
new Thing('electronics', [
    'microchip,1-6'
    'electronic component,1-6'
    'wire,0-2'
])
new Thing('microchip', [
    'electronic component,1-15'
    'plastic,75%'
    'copper,75%'
    'silicon,25%'
    'gold,5%'
...
new Thing('computer folder', [
    'computer folder,0-2'
    [
        'computer folder,0-6'
        'disturbing computer image,1-10'
        'stupid computer image,1-10'
        'cute computer image,1-10'
        'software,1-6'
        'video game,1-6'
    ]
], [
...
new Thing('computer trashbin', [
    'computer folder,0-4'
    'disturbing computer image,0-4'
], 'Trashbin')
...
new Thing('stupid computer image', [ '.computer file' ], [
    ...
    [
        'some dude'
        'some girl'
        'a rather unattractive fellow'
        'a rather unattractive lady'
        'a grotesque individual'
        'a clearly drunk guy'
        'a clearly drunk girl'
        'a bunch of kids with popped collars'
        'some muscular guy'
        'a masked guy'
        'some guy with a horse mask'
        'cosplaying kids'
        'orange people'
        'midgets'
        'a midget'
    ...
    [ ' ' ]
    [
        'setting fire to some stuff'
        'involved in a retardedly dangerous prank'
        'trying something extremely dangerous'
        'involved in what was probably a stupid bet'
        'doing stupid stuff'
        'in anatomically questionable shenanigans'
        'getting stupidly injured'
        'stretching the limits of stupidity'
        'in an absurdly dangerous stunt'
        'dancing to some cheesy music'
        'pestering dangerous animals'
        'doing that thing with the stuff'
...
new Thing('disturbing computer image', [ '.computer file' ], [
    [
        'An image of '
        'A possibly illegal image of '
        'A crude representation of '
        'A disturbing representation of '
        'A daring representation of '
        'A video of '
    ]
    [
        'a ¤¤¤¤¤¤'
...
new Thing('forum post', [ '.pixel paragraph' ], [
    [
        'A poll about '
        'An irate little person ranting about '
        'A bunch of shut-ins arguing about '
        'Two people sharing their love for '
        'Some hipsters chatting about '
        'Concerned parents discussing '
        'An inflammatory post about '
        'A thoughtful comment on '
        'An insightful post regarding '
        'A troll post about '
        'A flame war about '
        'Some spam about '
        'A comment on '
        ...
        'A heated argument about '
        'A passionate discussion about '
        'A single person complaining about '
        'A group of persons enthusiastic about '
    ]
    [
        'politics'
        'countries'
        ...
        'friendship'
        'stuff people put in their pockets'
        'computers'
        'cute things'
        'creepy things'
        'stupid things'
        ...
        'superheroes'
        'trolling'
        'jimmies being rustled'
        'filenames'
        'an online universe generator'
    ]
    [ '.' ]
])
new Thing('internet browser', [
    'nested,0.5%'
    'website'
], [
    [
...
new Thing('milk bottle', [
    '.bottle'
    'milk'
])
new Thing('wine bottle', [
    '.bottle'
    'wine'
])
new Thing('wine', [
...
new Thing('water bottle', [
    '.bottle'
    'water'
])
new Thing('juice bottle', [
    '.bottle'
    'juice'
])
new Thing('soda bottle', [
    '.bottle'
    'soda'
])
new Thing('juice', [
...
new Thing('spices', [ '.organic matter' ], [ [
    'pepper'
    'garlic'
    'onions'
    'rosemary'
...
new Thing('visitor torso', [
    'visitor chest'
    'visitor pelvis'
    '.body part'
], 'torso')
new Thing('visitor chest', [ '.body part' ], 'chest')
new Thing('visitor pelvis', [
    'visitor naughty bits'
    '.body part'
], 'pelvis')
new Thing('visitor naughty bits', [ '.soft body part' ], [ 'thrusher' ])
new Thing('visitor arm', [
    'visitor hand'
    'visitor elbow,2'
    'visitor armpit'
    '.body part'
], 'arm')
new Thing('visitor hand', [
    'visitor finger,3'
    '.body part'
], 'hand')
new Thing('visitor finger', [ '.body part' ], 'finger')
new Thing('visitor elbow', [ '.body part' ], 'elbow')
new Thing('visitor armpit', [
    'visitor ooze,70%'
    '.soft body part'
], 'armpit')
new Thing('visitor leg', [
    'visitor foot'
    'visitor knee'
    '.body part'
], 'leg')
new Thing('visitor foot', [
    'toe,4'
    'visitor ooze,40%'
    '.body part'
], 'foot')
...
new Thing('named visitor', [ '.visitor' ], [
    [ 'B' ]
    [
        'a'
        'b'
...
new Thing('visitor city', [
    'named visitor,0-8'
    [
        'space animal,0-3'
        ''
    ]
    'visitor neighborhood,1-8'
], 'visitor city')
new Thing('visitor neighborhood', [
    'named visitor,0-8'
    [
        'space animal,0-3'
        ''
    ]
    'visitor building,2-16'
], 'neighborhood')
new Thing('visitor building', [
    [
        'named visitor,0-8'
        ''
    ]
...
new Thing('visitor installation', [
    'named visitor,0-4'
    [
        'space animal,0-3'
        ''
    ]
    'visitor building,1-3'
], [
    [
        'pod'
        'grub'
...
new Thing('ancient continent', [
    'ancient land,1-5'
    'sea,1-5'
], [ 'continent' ])
new Thing('ancient land', [
    'ancient plain,0-5'
    [
        'ancient forest,0-4'
        'ancient jungle,0-4'
...
new Thing('medieval psyche', [
    'medieval thoughts'
    'medieval memories'
], 'psyche')
new Thing('medieval thoughts', [
    'black hole,0.01%'
    [ 'medieval thought,2-3' ]
], 'thoughts')
...
new Thing('medieval coat', [ '.medieval clothing' ], [
    'coat'
    'cloak'
    'cape'
    'robe'
...
new Thing('medieval hat', [ '.medieval clothing' ], [
    'hat'
    'hood'
    'headdress'
])
new Thing('armor', [ 'metal' ], [
    'chain-mail armor'
    'plate armor'
    'lamellar armor'
    'scale armor'
...
new Thing('helmet', [ 'metal' ], [
    'helm'
    'helmet'
])
new Thing('medieval weapon', [
    'metal'
    'wood'
], [
    'sword'
...
new Thing('medieval king', [ '.medieval person' ], [
    [ '*MEDIEVAL MAN*| (' ]
    [
        'king'
        'emperor'
...
new Thing('medieval queen', [ '.medieval person' ], [
    [ '*MEDIEVAL WOMAN*| (' ]
    [
        'queen'
        'empress'
...
new Thing('wizard', [ '.medieval person' ], [
    [ '*MEDIEVAL PERSON*| (' ]
    [
        'court'
        'battle'
...
new Thing('medieval gravedigger', [
    '.medieval person'
    'shovel,30%'
], '*MEDIEVAL PERSON*| (gravedigger)')
...
new Thing('medieval village', [
    'townwall,20%'
    'watchtower,15%'
    'medieval monument,50%'
    'medieval residential area,1-4'
    'medieval commercial area,1-2'
    'medieval temple,0-2'
    'medieval farm,4-8'
    'medieval cemetery,50%'
    'wizard tower,5%'
], 'village')
new Thing('medieval capital', [
    'castle'
    'townwall'
...
new Thing('watchtower', [
    'medieval guard,1-2'
    'medieval chest,30%'
    '.medieval building'
])
new Thing('castle keep', [
    'great hall'
    'noble medieval living quarters,1-3'
    'noble medieval bedroom,2-5'
    '.medieval building'
])
new Thing('great hall', [
    'medieval king,90%'
    'medieval queen,90%'
    'throne,2'
    'wizard,0-3'
...
new Thing('medieval commercial area', [
    'medieval inn,1-2'
...
new Thing('medieval mage quarter', [
    'wizard tower,1-5'
    'medieval inn,0-1'
    'medieval apothecary shop,0-3'
], 'mage district')
new Thing('medieval house', [
    'medieval living quarters'
    'medieval bedroom'
    'medieval bedroom,50%'
    '.medieval building'
], [
...
new Thing('medieval building', [
    'medieval walls'
    'roof'
], 'building')
new Thing('medieval room', [
    'visitor,0.1%'
    'ghost,0.1%'
    'medieval walls'
], 'room')
new Thing('medieval walls', [
    'door,1-4'
    'window,0-6'
    [
        'medieval wall,4'
...
new Thing('medieval wall', [
    'wood'
    'stone'
    'dirt,20%'
], 'stone wall')
new Thing('medieval living quarters', [
...
new Thing('medieval bedroom', [
    'medieval peasant,0-2'
    'medieval bed'
    'medieval bed,20%'
    'medieval table,30%'
    'medieval chair,0-4'
...
new Thing('noble medieval living quarters', [
    'wizard,10%'
    'medieval noble,0-4'
    'medieval servant,0-3'
    'medieval pantry,0-2'
    'medieval table'
    'medieval table,60%'
    'medieval chair,1-8'
...
new Thing('noble medieval bedroom', [
    'medieval noble,0-2'
...
new Thing('giant monster cage', [ [
    'dragon'
    'sea monster'
] ], 'giant cage')
new Thing('medieval shop', [
    'medieval shopkeeper,1-2'
    'medieval peasant,0-2'
    'medieval noble,40%'
    'medieval table,80%'
    'medieval chair,0-2'
...
new Thing('medieval tool shop', [
    'medieval clutter,1-6'
    'medieval chest,1-6'
    '.medieval shop'
], [
    [
...
new Thing('medieval clothing shop', [
    'medieval pants,1-3'
    'medieval shirt,1-3'
    'medieval coat,1-3'
    'medieval underwear,0-2'
    'medieval shoes,1-3'
    'medieval hat,0-3'
    'cloth,1-4'
    'loom'
...
new Thing('medieval butcher shop', [
    'medieval meat,2-10'
    'medieval food,0-3'
    '.medieval shop'
], [
...
new Thing('medieval food shop', [
    'sack of grain,1-6'
    'sack of medieval food,1-6'
    'medieval food,2-5'
    'medieval meat,1-4'
    '.medieval shop'
], [
...
new Thing('medieval apothecary shop', [
    'potion,1-8'
    'unusual stone,1-8'
    'unusual plant,1-8'
    'unusual ingredient,0-4'
    'wizard,20%'
    '.medieval shop'
], [
    'rare ingredients shop'
    'potion shop'
    'cures and remedies'
    'alchemy essenitals'
    'unusual wares shop'
...
new Thing('wizard tower', [
    'wizard,95%'
    'wizard,20%'
    'medieval servant,30%'
    'unusual ingredient,1-4'
    'medieval table,80%'
    'medieval chair,1-3'
    'medieval chest,1-4'
    'medieval clutter,2-4'
    '.medieval building'
])
new Thing('medieval cemetery', [
    'medieval gravedigger,0-2'
    'medieval person,0-3'
    'medieval grave,10-30'
    'ghost,20%'
    'ghost,10%'
], 'graveyard')
new Thing('medieval grave', [
    'medieval corpse,98%'
    'ghost,2%'
    'worm,0-3'
    'insect,0-1'
...
new Thing('medieval table', [
    'wood'
    'nails,50%'
], 'table')
new Thing('medieval bed', [
    'wood frame'
    'cloth'
    'pillow,0-3'
], 'bed')
new Thing('medieval chest', [
...
new Thing('medieval chest content', [
    'medieval clutter,0-2'
    [
...
new Thing('unusual ingredient', [ 'organic matter' ], [
    'dragon tooth'
    'dragon claw'
    'dragon scale'
    'unicorn horn'
...
new Thing('unusual plant', [ 'plant cell' ], [
    'mandrake'
    'myrrh'
    'vervain'
    'lotus'
...
new Thing('medieval meat', [ 'soft flesh' ], [
    [
        'cured '
        'prepared '
        'salted '
...
new Thing('dungeon wall', [
    'stone'
    'dirt,20%'
], 'stone wall')
new Thing('dungeon clutter', [
    'medieval monument,20%'
    'medieval altar,5%'
    'medieval corpse,3%'
    'medieval corpse,1%'
    ...
    'medieval bench,5%'
    'medieval bench,5%'
    'medieval fireplace,5%'
])
new Thing('dungeon tower', [
    'dungeon life'
    '.dungeon clutter'
    '.dungeon building'
    'roof'
], 'tower')
new Thing('dungeon passage', [
    'dungeon life'
    '.dungeon clutter'
    'dungeon room,60%'
    'dungeon room,40%'
...
new Thing('dungeon life', [
    '.dungeon monster'
    'insect,10%'
], 'life')
new Thing('dungeon monster', [ [
    'dragon'
    'ghost,1-3'
    'ghost,1-3'
    'wizard'
    'humanoid creature,1-3'
    'humanoid creature,1-3'
    'fairy,1-3'
    'fairy,1-3'
    'giant bug,1-3'
...
new Thing('creature thought', [], [
    'INTRUDER, INTRUDER!'
    'You no get out of here alive.'
    'This one, mine!'
    'I will suck its blood and then feast on its skin.'
    'I will rejoice in its blood!'
    'How skin tears joyfully under my teeth!'
    'Skin, blood, yes!'
    'Flesh. I crave flesh.'
    'Soft, juicy, scrumptious brains!'
    'Dibs on your skull.'
    'Fresh flesh ahead!'
    'None, you get none of the treasure!'
    'I detect you.'
    'Time for a feast.'
    'Adventurers are so rare these days.'
    'I have spotted you. You be dead soon.'
    'Crisp ribcages are the best.'
    'I will suck its eyeballs from their sockets.'
    'I will tear apart its ribs one by one.'
    'I will bathe in its red juice.'
    'I will strip it of its skin.'
    'I will puncture its heart.'
])
#future stuff
new Thing('future clothing set', [
    'future gizmo,10%'
    'future gizmo,10%'
    'future gizmo,10%'
    'future hat,10%'
...
new Thing('future continent', [ 'future city,20-50' ], [
    [ 'united continent of ' ]
    [
        'Eu'
        'A'
...
new Thing('dyson segment', [
    'future city,4-20'
    'nanocollector,12-20'
])
new Thing('sprowseship', [
...
new Thing('future outfit', [ '.future clothing' ], [
    [
        'blue'
        'pink'
        'yellow'
...
new Thing('future hat', [ '.future clothing' ], [
    [
        'little'
        'tall'
        'round'
...
new Thing('nanobookshelf', [
    'book,2-20'
    'nanoplasm'
])
new Thing('nanocupboard', [
    'future outfit,0-6'
    'future hat,0-4'
    'nanoplasm'
])
...
new Thing('future living-room stuff', [ 'nanoplasm' ], [
    'chair'
    'armchair'
    'couch'
    'table'
...
new Thing('future bedroom stuff', [ 'nanoplasm' ], [
    'bed'
    'chair'
    'desk'
    'lamp'
...
new Thing('future decoration stuff', [ 'nanoplasm' ], [
    'potted plant'
    'rug'
    'statue'
    'lamp'
...
new Thing('future gizmo', [ 'nanoplasm' ], [
    [
        'trans'
        'nano'
        'micro'
...
new Thing('future room', [
    'future door,1-2'
    'nanocarpet'
    'future wall,4'
], 'room')
new Thing('future home room', [
    'future person,0-3'
    'cat,2%'
    'dog,2%'
    'future gizmo,20%'
    ...
    'future tv,20%'
    [
        'future bathroom stuff,2-4'
        'future living-room stuff,3-7'
        'future bedroom stuff,2-6'
    ]
    'future decoration stuff,0-3'
    '.future room'
], 'room')
new Thing('future wall', [
    'nanopipe,0-2'
    'nanobrick,10-20'
], 'wall')
...
new Thing('future food room', [
    'pill rack,4-12'
    'future person,1-6'
    '.future room'
], 'pill store')
new Thing('future goods room', [
    [
        'nanocupboard,2-6'
        'future bathroom stuff,4-12'
        'future living-room stuff,4-12'
        'future bedroom stuff,4-12'
        'future decoration stuff,4-12'
        'future gizmo,4-12'
        'future tv,3-8'
        'nanobookshelf,4-12'
    ]
...
new Thing('future commercial building', [ [
    'future food room,1-6'
    'future goods room,1-6'
] ], [
    [
        'blobb'
        'blubb'
...
#caveman stuff
new Thing('ancient clothing set', [
    'ceremonial headdress,5%'
    'fur coat,95%'
    'fur boots,60%'
    'decorative bone,20%'
    'decorative bone,10%'
...
new Thing('decorative bone', [ 'bone' ], [
    'bone necklace'
    'bone earrings'
    'bone pin'
    'bone accessory'
])
new Thing('ceremonial headdress', [
    'fur'
    'feather'
    'pigment'
])
new Thing('caveman settlement', [
    'ancient person,1-8'
    'ancient tent,2-6'
    'wall painting,40%'
    'wall painting,20%'
    'campfire,80%'
    'ancient meat rack,0-3'
    'ancient clutter pile,0-3'
    'bone heap,30%'
], [ 'settlement' ])
new Thing('ancient tent', [
    'ancient person,0-3'
    'campfire,10%'
    'ancient meat rack,20%'
    'ancient meat rack,20%'
    ...
    'decorative bone,20%'
    'decorative bone,10%'
    'ancient clutter pile,30%'
    'ancient clutter pile,30%'
    'bone heap,5%'
    'leather'
], [ 'tent' ])
new Thing('ancient clutter pile', [
    'leather,80%'
    'fur,80%'
    'bone,80%'
    'wood,80%'
    ...
    'a pile of stone tools'
    'a pile of broken spears'
    'a pile of unfinished spears'
    'a pile of harpoons'
    'a pile of discarded bones'
    'a pile of miscellaneous rock tools'
    'a pile of dry furs'
    'a pile of smooth rocks'
    'a pile of firewood'
    'a pile of sticks'
    'a pile of stone figurines'
])
...
new Thing('wall painting', [ 'pigment' ], [
    [ 'Wall painting (' ]
    [
        'humans'
        'wild beasts'
